...
<div class="ds-section">
  <div class="ds-section-title">※共有IDの問題点</div>
  <div class="ds-compare col2">
...
<div class="ds-section">
  <div class="ds-section-title">3要素の詳細比較</div>
...
<div class="ds-section">
  ...
  <div class="ds-diagram-card">
    <div class="ds-actors">
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#dbeafe;color:#1e429f"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><rect x="3" y="4" width="18" height="12" rx="2"/><path d="M2 20h20"/></svg></div>
        <div class="ds-actor-name" style="color:#1e429f">サプリカント</div>
        <div class="ds-actor-sub">PC・スマホ</div>
      </div>
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#ede9fe;color:#5b21b6"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><path d="M5 12.55a11 11 0 0 1 14 0"/><path d="M1.42 9a16 16 0 0 1 21.16 0"/><path d="M8.53 16.11a6 6 0 0 1 6.95 0"/><circle cx="12" cy="20" r="1.5" fill="currentColor" stroke="none"/></svg></div>
        <div class="ds-actor-name" style="color:#5b21b6">オーセンティ<br>ケータ</div>
        <div class="ds-actor-sub">スイッチ・AP</div>
      </div>
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#d1fae5;color:#065f46"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/></svg></div>
    ...
    <div class="ds-svg-wrap">
      <svg viewBox="0 0 560 545" xmlns="http://www.w3.org/2000/svg" font-family="-apple-system,'Hiragino Kaku Gothic ProN',sans-serif">
        ...
        <text x="310" y="497" text-anchor="middle" font-size="9" font-weight="700" fill="#dc2626">※合否判定は RADIUS（スイッチでない）</text>
...
<div class="ds-section">
  <div class="ds-section-title">RADIUS vs TACACS+</div>
  <div class="ds-compare">
...
<div class="ds-section">
  <div class="ds-section-title">EAP 方式の比較</div>
  <div class="ds-compare col4">
...
<div class="ds-section">
  <div class="ds-section-title">FIDO 規格の比較</div>
  <div class="ds-compare">
...
<div class="ds-section">
  ...
  <div class="ds-diagram-card">
    <div class="ds-actors">
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#dbeafe;color:#1e429f"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg></div>
        <div class="ds-actor-name" style="color:#1e429f">ユーザ</div>
        <div class="ds-actor-sub">操作者</div>
      </div>
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#ede9fe;color:#5b21b6"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><rect x="3" y="4" width="18" height="12" rx="2"/><path d="M2 20h20"/></svg></div>
        <div class="ds-actor-name" style="color:#5b21b6">ブラウザ<br>/ 認証器</div>
        <div class="ds-actor-sub">CTAP/WebAuthn</div>
      </div>
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#d1fae5;color:#065f46"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div>
    ...
    <div class="ds-svg-wrap">
      <svg viewBox="0 0 560 490" xmlns="http://www.w3.org/2000/svg" font-family="-apple-system,'Hiragino Kaku Gothic ProN',sans-serif">
        ...
        <text x="340" y="472" text-anchor="middle" font-size="9" font-weight="700" fill="#dc2626">※パスワードはネットワークを流れない</text>
      </svg>
    </div>
  </div>
</div>
...
<div class="ds-section">
  <div class="ds-section-title">アクセス制御モデルの比較</div>
  <div class="ds-compare col4">
...
<div class="ds-section">
  <div class="ds-section-title">SSO プロトコルの比較</div>
  <div class="ds-compare col4">
...
<div class="ds-section">
  ...
  <div class="ds-diagram-card">
    <div class="ds-actors">
      ...
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#ede9fe;color:#5b21b6"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><path d="M3 21h18"/><path d="M5 21V9l7-6 7 6v12"/><path d="M9 21v-5a3 3 0 0 1 6 0v5"/></svg></div>
    ...
    <div class="ds-svg-wrap">
      <svg viewBox="0 0 560 470" xmlns="http://www.w3.org/2000/svg" font-family="-apple-system,'Hiragino Kaku Gothic ProN',sans-serif">
        ...
        <text x="280" y="450" text-anchor="middle" font-size="9" font-weight="700" fill="#dc2626">※TGT は KDC だけが復号可能 / ST はサービスだけが復号可能</text>
      </svg>
    </div>
  </div>
</div>
<div class="ds-section">
  <div class="ds-section-title">TGT と ST の違い</div>
  <div class="ds-compare">
...
<div class="ds-section">
  ...
  <div class="ds-diagram-card">
    <div class="ds-actors col4">
      ...
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#ede9fe;color:#5b21b6"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><rect x="6" y="2" width="12" height="20" rx="2"/><circle cx="12" cy="18" r="0.8" fill="currentColor" stroke="none"/></svg></div>
        <div class="ds-actor-name" style="color:#5b21b6">クライアント<br>App</div>
        <div class="ds-actor-sub">Client</div>
      </div>
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#fef3c7;color:#92400e"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><circle cx="7.5" cy="15.5" r="5.5"/><path d="m21 2-9.6 9.6"/><path d="m15.5 7.5 3 3L22 7l-3-3"/></svg></div>
        <div class="ds-actor-name" style="color:#92400e">認可サーバ</div>
        <div class="ds-actor-sub">Auth Server</div>
      </div>
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#d1fae5;color:#065f46"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4.03 3 9 3s9-1.34 9-3V5"/><path d="M3 12c0 1.66 4.03 3 9 3s9-1.34 9-3"/></svg></div>
    ...
    <div class="ds-svg-wrap">
      <svg viewBox="0 0 640 530" xmlns="http://www.w3.org/2000/svg" font-family="-apple-system,'Hiragino Kaku Gothic ProN',sans-serif">
        ...
        <text x="180" y="508" text-anchor="middle" font-size="8" fill="#6b7280">※step6の破線がバックチャネル（安全の核心）</text>
      </svg>
    </div>
  </div>
</div>
...
<div class="ds-section">
  ...
  <div class="ds-diagram-card">
    <div class="ds-actors">
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#dbeafe;color:#1e429f"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg></div>
        <div class="ds-actor-name" style="color:#1e429f">ブラウザ</div>
        <div class="ds-actor-sub">ユーザ操作</div>
      </div>
      <div class="ds-actor">
        <div class="ds-actor-icon" style="background:#ede9fe;color:#5b21b6"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" width="22" height="22"><rect x="3" y="3" width="18" height="18" rx="1"/><path d="M9 3v18"/><path d="M3 9h6"/><path d="M3 15h6"/><path d="M12 9h9"/><path d="M12 15h9"/><path d="M12 3h9"/></svg></div>
...
<div class="ds-section">
  <div class="ds-section-title">SP-Initiated vs IdP-Initiated</div>
  <div class="ds-compare">
